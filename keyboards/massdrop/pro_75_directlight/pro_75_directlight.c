 ...
 *   |  |       |       | */
    ...
    {0, B_8,    A_8,    C_8}, // SD8
    {0, B_9,    A_9,    C_9}, // SD9
    {0, B_10,   A_10,   C_10}, // SD10
    {0, B_11,   A_11,   C_11}, // SD11
    {0, B_12,   A_12,   C_12}, // SD12
    {0, B_13,   A_13,   C_13}, // SD13
    {0, B_14,   A_14,   C_14}, // SD14
    ...
    {1, K_8,    J_8,    L_8}, // SD28
    {1, K_9,    J_9,    L_9}, // SD27
    {1, K_10,   J_10,   L_10}, // SD26
    {1, K_11,   J_11,   L_11}, // SD25
    {1, L_12,   J_12,   L_12}, // SD24
    {1, K_13,   J_13,   L_13}, // SD23
    {1, K_16,   J_16,   L_16}, // SD20
    {1, K_15,   J_15,   L_15}, // SD21

    {1, K_1,    J_1,    L_1}, // SD35
    {1, K_14,   J_14,   L_14}, // SD22
};
...
led_config_t g_led_config = { {
  ...
  /* Underglow / Border */
  {5, 3}, {213, 3},
  {1, 7}, {17, 6}, {44, 7}, {60, 7}, {76, 7}, {92, 7}, {108, 7}, {124, 7}, {140, 7}, {156, 7}, {172, 7}, {188, 7}, {204, 7}, {214, 7}, {224, 7},
  {18, 20}, {214, 20},
  {18, 32}, {214, 32},
  {18, 43}, {214, 43},
  {1, 55}, {17, 55}, {44, 55}, {60, 55}, {76, 55}, {92, 55}, {108, 55}, {124, 55}, {140, 55}, {156, 55}, {172, 55}, {188, 55}, {204, 55}, {214, 55}, {224, 55},
  {18, 63}, {214, 63},
}, {
  /* LED Index to Flag */
